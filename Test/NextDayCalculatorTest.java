...
class NextDayCalculatorTest {
    ...
    @Test
    void testNextDayCalculator11() {
        int date = 30;
        int month = 1;
        int year = 2018;
        String expected = "31-1-2018";
